<template>
  <div>
    <content-header :tip="`我关注的人的最新主题`"></content-header>
...
import { getThemeListByUserAttention } from "@api/theme/themeApi";
...
export default {
  ...
  methods: {
    ...
    getThemeVOListFromServer(page, pageSize) {
      getThemeListByUserAttention(page, pageSize).then(data => {
